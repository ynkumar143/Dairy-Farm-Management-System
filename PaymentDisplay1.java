 ...
 * @author Puppy
 */
public class PaymentDisplay1 extends javax.swing.JFrame {
String driver = "org.apache.derby.jdbc.ClientDriver";
  ...
  TableColumn tc;  
   Double sum=0.0;
    String result_finale1;
  int xw;
  JTable tblcu[];
   JTable tblcus[];
     JTable tblcud[];
    // JTable tabletest2=new JTable();
...
//private JTable CompTable = null;
 ...
 Connection con1,con2,con3,con4,con5,con6,con7;
...
//        jScrollPane1.setVisible(false);
      ...
      // ImagePanel panelinsert = new ImagePanel(new ImageIcon("images/background.png").getImage());  
        ...
        //JOptionPane.showMessageDialog(PaymentDisplay1.this,getcound1);
    ...
    public void Createcomptable2()
{
  ...
  // addRow();
   ...
   // JTable tabletest=new JTable(CompModel);
    ...
    tabletest1.setRowHeight(80);
    tabletest1.setTableHeader(null);
   
   // tabletest.setDefaultEditor(Object.class, PanelCellEditorRenderer);
   // return tabletest;
}
     public void Createcomptable4()
{
  
  // addRow();
   
   // JTable tabletest=new JTable(CompModel);
    tabletest3.setModel(dtm7);
     tabletest3.setAutoResizeMode(tabletest.AUTO_RESIZE_OFF);
    tabletest3.setRowHeight(80);
    tabletest3.setTableHeader(null);
 ...
 public void Createcomptable()
{
  ...
  public void Createcomptable3()
{
  
  // addRow();
   
   // JTable tabletest=new JTable(CompModel);
   // JOptionPane.showMessageDialog(PaymentDisplay1.this,"HI");

           
  //   tabletest2.setAutoResizeMode(tabletest2.AUTO_RESIZE_OFF);
    tabletest2.setRowHeight(45);
    tabletest2.setTableHeader(null);
              ...
              String days1=daysdiff.getText();
                 ...
                 //   cols.setSize(100);
                    ...
                    for(int j=0;j<days2;j++)
                    {
                         ...
                         cal4.setTime(d1);
                           cal4.add(Calendar.DATE,+j);
                           row3.add(sdf3.format(cal4.getTime()));    
                    }
                    row3.add("S.TOTAL");
                    row3.add("TOTAL");
                    row3.add("GIVEN");
                    ...
                    row3.add("SIGN");
                    data.add(row3);
                    tabletest2 =new JTable(data,cols);
                      DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
rightRenderer.setHorizontalAlignment( JLabel.CENTER );
            // tblcu[w].setValueAt("Nagendra", 1, 3);
               tabletest2.getColumnModel().getColumn(0).setPreferredWidth(60);
               tabletest2.getColumnModel().getColumn(0).setCellRenderer( rightRenderer );
                     tabletest2.getColumnModel().getColumn(1).setPreferredWidth(150);
                     tabletest2.getColumnModel().getColumn(1).setCellRenderer( rightRenderer );
                      tabletest2.getColumnModel().getColumn(2).setPreferredWidth(50);
                      tabletest2.getColumnModel().getColumn(2).setCellRenderer( rightRenderer );
                      for(int j=3;j<(days2+3);j++)
                    {
                     tabletest2.getColumnModel().getColumn(j).setPreferredWidth(75);
                     tabletest2.getColumnModel().getColumn(j).setCellRenderer( rightRenderer );
                    }
                     tabletest2.getColumnModel().getColumn(days2+3).setPreferredWidth(85);
                      tabletest2.getColumnModel().getColumn(days2+3).setCellRenderer( rightRenderer );
                     tabletest2.getColumnModel().getColumn(days2+4).setPreferredWidth(85);
                     tabletest2.getColumnModel().getColumn(days2+4).setCellRenderer( rightRenderer );
                      tabletest2.getColumnModel().getColumn(days2+5).setPreferredWidth(80);
                     tabletest2.getColumnModel().getColumn(days2+5).setCellRenderer( rightRenderer );
                     tabletest2.getColumnModel().getColumn(days2+6).setPreferredWidth(80);
                     tabletest2.getColumnModel().getColumn(days2+6).setCellRenderer( rightRenderer );
                    tabletest2.getColumnModel().getColumn(days2+7).setPreferredWidth(50);
                     tabletest2.getColumnModel().getColumn(days2+7).setCellRenderer( rightRenderer );
                     tabletest2.getColumnModel().getColumn(days2+8).setPreferredWidth(60);
                     tabletest2.getColumnModel().getColumn(days2+8).setCellRenderer( rightRenderer );
                     tabletest2.setBackground(Color.YELLOW) ;
                 // head.getColumnModel().setColumnMargin();
                  tabletest2.setShowHorizontalLines(false);
                  tabletest2.setRowHeight(80);
             tabletest2.setForeground(Color.BLACK);
             tabletest2.setFont(new Font("Times New Roman",Font.BOLD,14));
             tabletest2.setBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY,2));
   // tabletest.setDefaultEditor(Object.class, PanelCellEditorRenderer);
   // return tabletest;
}
...
public class Renderer3 extends DefaultTableCellRenderer{
...
public void addRow2() {
  ...
  // Renderer2 PanelCellEditorRenderer = new Renderer2();
   tabletest3.setDefaultRenderer(Object.class, PanelCellEditorRenderer);
   int nag=tabletest1.getColumnCount();
    ...
    if(nag<1)
       ...
       if(bav==0)
       {
         ...
         for(Object[] r2:row2)
         dtm7.addRow(r2);
         tabletest3.getColumnModel().getColumn(0).setPreferredWidth(1600);
       }
...
//         tabletest.getColumnModel().getColumn(0).setPreferredWidth(1600);
       ...
       Object[][] row8={{tabletest3}};
       for(Object[] r8:row8)
       dtm4.addRow(r8);
       tabletest.getColumnModel().getColumn(0).setPreferredWidth(1600);
//       labelttal.setText(lbltotaltxt.getText());
    }
    ...
    public void DateDisplay(){
     ...
     public void datediff()
     {
		...
		double diffDays = diff / (24 * 60 * 60 * 1000);
                ...
                if(diffDays2<0)
                {
                    JOptionPane.showMessageDialog(PaymentDisplay1.this,"Date Selection is not possible! Date after present day is not allowed");
                }
                else
                {
   ...
   ////contentPane.add(button, BorderLayout.SOUTH);
    ...
    // }
     ...
     sortlist1();
         ...
         //  JOptionPane.showMessageDialog(PaymentDisplay1.this,"dsadf");
           //  n=w;
     // n=w;
            // chItemStateChanged();
    ...
    {
        JOptionPane.showMessageDialog(PaymentDisplay1.this,err);
    }
     }
          ...
          
      {
        ...
        // int days2=Integer.parseInt(days1);
          SimpleDateFormat sdf4=new SimpleDateFormat(DATE_FORMAT_NOW);
            ...
            stmt7.executeQuery("SELECT MILK,MONEY,RECIEVED,DATE,SESSION FROM DAILYSALES where CARD_NUM="+val1);
            res7=stmt7.getResultSet();
...
//               
                    ...
                    String value1=res7.getString("DATE");
                    Object milk=res7.getInt("MILK");
                    Object money=res7.getDouble("MONEY");
                    Object status=res7.getString("RECIEVED");
                    String session=res7.getString("SESSION");
             ...
             valuetotal.setText(salesnotgiven2);
             ...
             for(int p=3;p<(days2+3);p++)
                                          {
                                            ...
                                            // Double values1=Double.parseDouble(values);
                                             tblcu[w].setValueAt("0", 0, p);
                                             tblcu[w].setValueAt("0",1,p);
...
//                                             }
                       ...
                       while(res2.next())
                                 {  
                                         String id=res2.getString("CARD_NUM");
                                          Integer idcn0=Integer.parseInt(id);
                                         String date2=res2.getString("DATE");
                                         Object money=res2.getString("MONEY");
                                         String sess=res2.getString("SESSION");
                                         tblcu[w].setValueAt(idcn0,0,(days2+7));
                                         //String name=res2.getString("CUST_NAME");
                                         for(int j=3;j<(days2+3);j++)
                    {
                 ...
                 //  tblcust.setR
                        for(int q=3;q<days2+3;q++)
         {
             Object result=tblcu[w].getValueAt(0, q);
             Object resultpm=tblcu[w].getValueAt(1,q);
            // JOptionPane.showMessageDialog(PaymentDisplay.this,result);
             String result1=result.toString();
             
             
             String resultpm1=resultpm.toString();
             String givent=valuetotal.getText();
            
             giventd=Double.parseDouble(givent);
            // lblname.setText(result1);
            Double result2=Double.parseDouble(result1);
            Double resultpm2=Double.parseDouble(resultpm1);
          //  int valued=Integer.parseInt(result1);
             ...
             String result_fval=df.format(sum3);
             diff4=sum3-giventd;
             result_finale1=df.format(diff4);
             ...
             tblcu[w].setValueAt(result_val1, 1, (days2+3));
             tblcu[w].setValueAt(result_fval, 0, (days2+4)); 
             tblcu[w].setValueAt(giventd, 0, (days2+5));
             tblcu[w].setValueAt(result_finale1,0,(days2+6));
             
           // JOptionPane.showMessageDialog(PaymentDisplay1.this,result_finale1);
         }
...
rightRenderer.setHorizontalAlignment( JLabel.CENTER );
            // tblcu[w].setValueAt("Nagendra", 1, 3);
               tblcu[w].getColumnModel().getColumn(0).setPreferredWidth(60);
               tblcu[w].getColumnModel().getColumn(0).setCellRenderer( rightRenderer );
                     tblcu[w].getColumnModel().getColumn(1).setPreferredWidth(150);
                     
                     tblcu[w].getColumnModel().getColumn(1).setCellRenderer( rightRenderer );
                      tblcu[w].getColumnModel().getColumn(2).setPreferredWidth(50);
                      ...
                      for(int j=3;j<(days2+3);j++)
                    {
                     ...
                     tblcu[w].getColumnModel().getColumn(days2+3).setPreferredWidth(85);
                     tblcu[w].getColumnModel().getColumn(days2+3).setCellRenderer( rightRenderer );
                     tblcu[w].getColumnModel().getColumn(days2+4).setPreferredWidth(85);
                     tblcu[w].getColumnModel().getColumn(days2+4).setCellRenderer( rightRenderer );
                     tblcu[w].getColumnModel().getColumn(days2+5).setPreferredWidth(80);
                     tblcu[w].getColumnModel().getColumn(days2+5).setCellRenderer( rightRenderer );
                     tblcu[w].getColumnModel().getColumn(days2+6).setPreferredWidth(80);
                     tblcu[w].getColumnModel().getColumn(days2+6).setCellRenderer( rightRenderer );
                     tblcu[w].getColumnModel().getColumn(days2+7).setPreferredWidth(50);
                     tblcu[w].getColumnModel().getColumn(days2+7).setCellRenderer( rightRenderer );
                      tblcu[w].getColumnModel().getColumn(days2+8).setPreferredWidth(60);
                     tblcu[w].getColumnModel().getColumn(days2+8).setCellRenderer( rightRenderer );
                 // tblcu[w].set
                     // tblcu[w].setDefaultRenderer(MyRenderer);
                     
                     String nag1=tblcu[w].getValueAt(0, days2+4).toString();
                    // String nag1= result_finale1;
               
             Double nada=Double.parseDouble(nag1);
             vald[w]=nada;
            //JOptionPane.showMessageDialog(PaymentDisplay1.this,nag1);
                  tblcu[w].setBackground(Color.WHITE) ;
                 // head.getColumnModel().setColumnMargin();
                  tblcu[w].setShowHorizontalLines(false);
                  tblcu[w].setRowHeight(25);
             tblcu[w].setForeground(Color.BLACK);
             tblcu[w].setFont(new Font("Times New Roman",Font.BOLD,14));
             tblcu[w].setBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY,2));
            
             //nag=Double.parseDouble(nag1);
            // String nagd=lbltotal.getText();
             //Double nagds=Double.parseDouble(nagd);
             //Double nad=nagds+nada;
             //String nadss=df.format(nad);
             //lbltotal.setText(nadss);
           // Createcomptable();
           //  tabletest.setValueAt(tblcu[xw], 0, 0);
...
//                    
    JOptionPane.showMessageDialog(PaymentDisplay1.this, "HI");
//       
 //   System.out.println(tblcu[1].getValueAt(0, 0));
        JOptionPane.showMessageDialog(PaymentDisplay1.this,tblcu[1].getValueAt(0, 0));
   // }
}
     ...
     public void calculatesum()
     {
        ...
        for(int j=0;j<getcound1;j++)
        {
           ...
           // String sum1=sum.toString();
            ...
            //JOptionPane.showMessageDialog(PaymentDisplay1.this, sum);
            lbltotaltxt.setText(sum3);
            labeltotal.setText(lbltotaltxt.getText());
            lblfromdate.setText(txtfromdate.getText());
            lbltodate.setText(txttodate.getText());
            //dfj
     }
...
//  }    
    ...
    private void initComponents() {
        ...
        lbltotaltxt = new javax.swing.JTextField();
        jButton4 = new javax.swing.JButton();
        jScrollPane5 = new javax.swing.JScrollPane();
        givemoneyam = new javax.swing.JTable();
        jScrollPane6 = new javax.swing.JScrollPane();
        givemoneyam1 = new javax.swing.JTable();
        jScrollPane7 = new javax.swing.JScrollPane();
        givemoneyam2 = new javax.swing.JTable();
        jScrollPane8 = new javax.swing.JScrollPane();
        givemoneyam3 = new javax.swing.JTable();
        ...
        jLabel17.setText("Payment Display for Customers in Dairy");
        ...
        lable2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dairyvsr/dadadf.png"))); // NOI18N
        ...
        jScrollPane3.setViewportView(tabletest2);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel1.setText("Total:");

        lbltotaltxt.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        lbltotaltxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lbltotaltxtActionPerformed(evt);
            }
        });

        jButton4.setBackground(new java.awt.Color(255, 204, 204));
        jButton4.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jButton4.setText("Particular");
        ...
        givemoneyam1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        givemoneyam1.setRowHeight(28);
        jScrollPane6.setViewportView(givemoneyam1);

        givemoneyam2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        givemoneyam2.setRowHeight(28);
        jScrollPane7.setViewportView(givemoneyam2);

        givemoneyam3.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        givemoneyam3.setRowHeight(28);
        jScrollPane8.setViewportView(givemoneyam3);
        ...
        jScrollPane4.setViewportView(tabletest3);

        paneld2.setBackground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(scrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 999, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jCheckBox1)
                        .addComponent(jLabel1)
                        .addComponent(lbltotaltxt, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//                }
    ...
    private void tblsalesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblsalesMouseClicked
        ...
        try {
            ...
            JOptionPane.showMessageDialog(PaymentDisplay1.this, "Please Fill Details of Customer on this day");
        }
    }//GEN-LAST:event_tblsalesMouseClicked

    private void lbltotaltxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lbltotaltxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_lbltotaltxtActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentDisplay1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentDisplay1().setVisible(true);
    ...
    private javax.swing.JTable givemoneyam1;
    private javax.swing.JTable givemoneyam2;
    private javax.swing.JTable givemoneyam3;
    ...
    private javax.swing.JTextField lbltotaltxt;
